		...
		<tr>
			...
			<td>
				...
				<input type="text" name="price" id="price" 
					value="<?php echo $objForm->stickyText('price', '0.00'); ?>" class="fld_price" />
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="weight" id="weight" 
					value="<?php echo $objForm->stickyText('weight', '0.00'); ?>" class="fld_price" />
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="identity" id="identity" 
					value="<?php echo $objForm->stickyText('identity'); ?>" class="fld" />
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="meta_title" id="meta_title" 
					value="<?php echo $objForm->stickyText('meta_title'); ?>" class="fld" />
			</td>
		</tr>
